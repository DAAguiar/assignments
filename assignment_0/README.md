...
1. Try running the `tests/test_pyproject.py` file first - it should **fail**. You can do it with:
    ...
    Depending on whether yWou already have `pytest` installed, the command might not even work. If that's the case, don't worry. It will be installed in the next steps.  
